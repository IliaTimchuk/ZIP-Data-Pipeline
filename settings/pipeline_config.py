...
# Landing: Immutable raw zone containing original compressed (.zip) source archives.
LANDING_BUCKET = "landing"

# Bronze: Raw extracted layer storing PyArrow-decompressed Parquet files.
BRONZE_BUCKET = "bronze"

# Silver: Cleansed operational layer storing deduplicated, type-casted Apache Iceberg tables.
